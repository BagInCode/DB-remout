...
namespace DBMSClient.ServiceReference1 {
    ...
    public interface IDBMSService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDBMSService/TablesIntersection", ReplyAction="http://tempuri.org/IDBMSService/TablesIntersectionResponse")]
        DBMSClient.ServiceReference1.Table TablesIntersection(DBMSClient.ServiceReference1.Table firstTable, DBMSClient.ServiceReference1.Table secondTable);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDBMSService/TablesIntersection", ReplyAction="http://tempuri.org/IDBMSService/TablesIntersectionResponse")]
        System.Threading.Tasks.Task<DBMSClient.ServiceReference1.Table> TablesIntersectionAsync(DBMSClient.ServiceReference1.Table firstTable, DBMSClient.ServiceReference1.Table secondTable);

        [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/IDBMSService/TemplateSearch", ReplyAction = "http://tempuri.org/IDBMSService/TemplateSearchResponse")]
        DBMSClient.ServiceReference1.Table TemplateSearch(int tableIndex, List<string[]> Filters);
    }
    ...
    public partial class DBMSServiceClient : System.ServiceModel.ClientBase<DBMSClient.ServiceReference1.IDBMSService>, DBMSClient.ServiceReference1.IDBMSService {
        ...
        public DBMSClient.ServiceReference1.Table TablesIntersection(DBMSClient.ServiceReference1.Table firstTable, DBMSClient.ServiceReference1.Table secondTable) {
            return base.Channel.TablesIntersection(firstTable, secondTable);
        }

        public DBMSClient.ServiceReference1.Table TemplateSearch(int tableIndex, List<string[]> Filters)
        {
            return base.Channel.TemplateSearch(tableIndex, Filters);
        }
        
        public System.Threading.Tasks.Task<DBMSClient.ServiceReference1.Table> TablesIntersectionAsync(DBMSClient.ServiceReference1.Table firstTable, DBMSClient.ServiceReference1.Table secondTable) {
            return base.Channel.TablesIntersectionAsync(firstTable, secondTable);
        }
    }
}
